  ...
  return (
    <div>
      <div className='absolute top-0 left-0 h-full w-full  p-7 flex flex-col justify-between'>
        ...
        <div>
          <p className='text-shadow-2xs text-sm leading-normal text-white mb-4'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Saepe excepturi beatae, adipisci nostrum repellendus dolor?</p>
